            ...
            try {
                ...
                if (icmd) {
                    ...
                    if (cmd) {
                        ...
                        isCreator = [hgg,...kalindu,...global.sudo.split(','),...global.devs,...global.owner].map((v) => v.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(citel.sender);
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        console.log("✅  BOT CONNECTED SUCCESFUL!");
