...
try {
    ...
    console.log("🌍 Connected to the BUTTER-QUEEN-MD DB")
} catch {
...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var { body } = citel
		        const suhail = ['94758179948','94758179948'] ;
            ...
            try {
                ...
                for (let num of participants) {
                    ...
                    if (checkinfo) {
                        ...
                        //try{ if (anu.id === '120363162305531586@g.us' && !suhails ) return }
                        //catch(e){console.log(`IsSuhail : ${suhails} \nGroup Id : ${anu.id}\nerror Returning in BUTTER-QUEEN-Md Group : ` , e)}
